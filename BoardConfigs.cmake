...
elseif ( HW_CONFIG EQUAL 8 )
    ...
    if ( USE_HSTX EQUAL 1 AND NOT DEFINED GPIOHSTXD0 AND FORCE_DVI EQUAL 0)
        ...
        set(USEPICOHDMI 1 CACHE BOOL "Set to 1 to use PICO HDMI with HSTX")
   endif()
...
if (NOT DEFINED USEPICOHDMI)
    set(USEPICOHDMI 0 CACHE BOOL "Set to 1 to use PICO HDMI with HSTX")
endif()
...
if ( NOT GPIOHSTXD0 EQUAL 0 )
    ...
    message("Use PICO HDMI         : ${USEPICOHDMI}")
else()
