if ( HW_CONFIG EQUAL 1 )
    ...
    set(USE_EXTERNAL_AUDIO 1 CACHE STRING "Enable external audio output") # Enable external audio output for Pimoroni Pico DV Demo Base
    set(USE_AUDIO_I2S 1 CACHE STRING "Enable I2S audio output") # Enable I2S audio output for Pimoroni Pico DV Demo Base
...
elseif ( HW_CONFIG EQUAL 2 )
    ...
    set(USE_EXTERNAL_AUDIO 0 CACHE STRING "Enable external audio output") # Enable external audio output for Pimoroni Pico DV Demo Base
    set(USE_AUDIO_I2S -1 CACHE STRING "Enable I2S audio output") # Enable I2S audio output for Pimoroni Pico DV Demo Base
...
elseif ( HW_CONFIG EQUAL 3 )
    ...
    set(WIIPAD_I2C "i2c1" CACHE STRING "Select the I2C bus for Wii Classic controller")
	set(UART_ENABLED 1 CACHE STRING "Enable UART output")
    set(USE_EXTERNAL_AUDIO 0 CACHE STRING "Enable external audio output") 
    set(USE_AUDIO_I2S -1 CACHE STRING "Enable I2S audio output") 
    set(PICO_AUDIO_I2S_DATA_PIN -1 CACHE STRING "Select the GPIO pin for I2S data")
    set(PICO_AUDIO_I2S_CLOCK_PIN_BASE -1 CACHE STRING "Select the GPIO pin for I2S clock")
    set(PICO_AUDIO_I2S_PIO 1 CACHE STRING "Select the PIO for I2S audio output")
...
message("External audio output : ${USE_EXTERNAL_AUDIO}")
message("I2S audio output      : ${USE_AUDIO_I2S}")
